...
async function fulfilPencilledOffer({
  ...
  return transactionRunner(connectionString, async client => {
    ...
    const booking = await client.query(
      `INSERT INTO lesson_bookings
       ...
       VALUES ($1,$2,$3::date,$4::time,$5::time,$6,'instructor_offer','card',$7,$8,$9,$10,$11,
               'stripe_metadata',$12,'balance_transaction') RETURNING id`,
    ...
    await client.query(
      ...
      [schoolId, booking.rows[0].id, tx.rows[0].id, durationMins, rate, amountPence, fundingEvidence.feePence || 0]
    );
