...
- **Calendar:** Horizontal date strip for the full 4-week self-serve window, with selected-date time groups (`Morning`, `Afternoon`, `Evening`). Date and time selections are real buttons with accessible labels and 44px+ touch targets.
