...
- Bank-paid Reserved Weekly Slot v1 follows the same default cancellation value rule: eligible 48+ hour learner cancellations return same-instructor Lesson Credit, not automatic cash or Stripe refunds. Cash/original-payment-method refunds remain admin/operator exceptions until Pay by Bank production refund behaviour, partial refunds, timing, and account-specific fee treatment are confirmed against the real CoachCarter Stripe account.
